...
import gmibank.pages.US012_ManageCustomerPage;
...
public class US012_ManageCustomerStepDefinition {

    WebElement option;
    String oldValue, newData;
    US012_ManageCustomerPage us012_manageCustomerPage = new US012_ManageCustomerPage();
