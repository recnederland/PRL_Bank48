...
import gmibank.pages.US014_DateOfAccountCreationPage;
...
public class US014_DateOfAccountCreationStepDefinition {

    String dateholder;
    LocalDateTime now= LocalDateTime.now();

    US014_DateOfAccountCreationPage us014_dateOfAccountCreationPage= new US014_DateOfAccountCreationPage();
