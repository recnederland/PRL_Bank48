...
import gmibank.pages.US011_DateOfCustomerCreationPage;
...
import static gmibank.utilities.Driver.selectRandomTextFromDropdown;
import static gmibank.utilities.Driver.setAttribute;

public class US011_DateOfCustomerCreationStepDefinition {
    String dateholder;
    WebElement option;
    LocalDateTime now= LocalDateTime.now();
    Random random = new Random();

        US011_DateOfCustomerCreationPage us011_dateOfCustomerCreationPage = new US011_DateOfCustomerCreationPage();
