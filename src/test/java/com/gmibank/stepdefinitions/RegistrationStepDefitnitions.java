...
//    ChromeDriver driver = new ChromeDriver();
    ...
    public void userProvidesAValidSsn() throws InterruptedException {
        Thread.sleep(1000);
        regiser.ssnTextBox.sendKeys(faker.idNumber().ssnValid());
    }
    ...
    public void userProvidesAValidUsername() throws InterruptedException {
        Thread.sleep(1000);
        regiser.userNameTextBox.sendKeys(faker.name().username()); // ebubekir.sahin
    }
    ...
    public void userProvidesAValidPassword() throws InterruptedException {
        Thread.sleep(1000);
        regiser.firstPasswordTextBox.sendKeys(password);
    }
    ...
    public void userProvidesAValidPasswordConfirmation() throws InterruptedException {
        Thread.sleep(1000);
        regiser.secondPasswordTextBox.sendKeys(password);
    }
