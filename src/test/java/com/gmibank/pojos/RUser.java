...
public class RUser {
     ...
     * @param activated
     */
    public RUser(Integer id, String login, String firstName, String lastName, String email, Boolean activated, String langKey, Object imageUrl, Object resetDate) {
// constructries;larda superleri silelim
        this.id = id;
        this.login = login;
